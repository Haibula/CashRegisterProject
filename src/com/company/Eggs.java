...
public class Eggs {
    ...
    static ResultSet rs;
    private String productName = wareHouse.getProductName("яица");
    private String quantity = wareHouse.getProductQuantity("яица");
    private String price = wareHouse.getProductPrice("яица");
    private String productkod = wareHouse.getProductKod("яица");

    public Eggs() throws SQLException {
    }
    ...
    String getSmallInfoProduct() throws SQLException {
        ...
        while (rs.next()) {
            ...
            int quantitPurchase = MethotsForTableWareHouse.countEggs+1;
